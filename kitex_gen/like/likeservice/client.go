...
func (p *kLikeServiceClient) LikeVideo(ctx context.Context, req *like.LikeReq, callOptions ...callopt.Option) (r *like.LikeResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.LikeVideo(ctx, req)
}

func (p *kLikeServiceClient) DeleteLike(ctx context.Context, req *like.DeleteReq, callOptions ...callopt.Option) (r *like.DeleteResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
