...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.Delete_ = field.NewInt64(tableName, "delete")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.Delete_ = field.NewInt64(table, "delete")
...
type IFollowDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Follow, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (f followDo) FilterWithNameAndRole(name string, role string) (result []model.Follow, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM follow WHERE name = ? ")
	if role != "" {
