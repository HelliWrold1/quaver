...
type Comment struct {
	...
	AuthorID int64     `gorm:"column:author_id;type:int unsigned;not null" json:"author_id"` // 评论者id
	VideoID  int64     `gorm:"column:video_id;type:int unsigned;not null" json:"video_id"`   // 被评论的视频id
